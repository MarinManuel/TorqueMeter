...
"QPushButton:checked{ background: rgb(255, 0, 0);}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rejectFileButton.setText(QCoreApplication.translate("MainWindow", u"&Reject && Next", None))
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(shortcut)
        self.validateButton.setShortcut(QCoreApplication.translate("MainWindow", u"A", None))
#endif // QT_CONFIG(shortcut)
